...
save_meshes = 1;  % save tomograms on REGULAR 3 D mesh
...
%             SLICES.Yp = [-300:100:1700];
%             SLICES.Zp = [0 100 200 250 300 350 390 400 410 420 430 440 450];
        case {10,14,15} % P-wave tomography for SRL paper by Parker et al.
            SLICES.Xp = [0 250 500];
...
%             SLICES.Zp = [1300 1200 1150 1100 1050]-800; 
    ...
    switch obsq
        case {0,1,2,3,4,7,8,9,10,11,13,14,15}
