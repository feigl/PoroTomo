...
subplot('Position',[0., 0., 0.02 OuterPosition(4)-1],'Units','Inches','Parent',handle);
text(0.,1.,vlabel ...
            ,'Units','inches'...
...
subplot('Position',[0.04, 0.0, OuterPosition(3)-1 0.02],'Units','Inches','Parent',handle);
text(1.,0.,hlabel ...
            ,'Units','inches'...
...
% set(handle,'PaperPosition',[0,0,OuterPosition(3:4)]);
% set(handle,'PaperSize',OuterPosition(3:4));
%handle = gcf;
